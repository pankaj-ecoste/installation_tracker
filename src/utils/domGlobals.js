...
import { renderProjects, toggleChecklistDropdown, renderChecklistDropdown, renderAllChecklistDropdowns, acknowledgeChecklist, renderCard, toggleCard, renderDetail, filterByOpenConstraints, clearOpenConstraintsFilter } from '../sections/projects/projectCards.js';
import { fieldRowHTML, captureDPRArrivalGeoLocation, captureGeoLocation, reqFieldChanged, reqScopeChanged, renderRequestFields, openAddRequest, openEditRequest, genRequestNumber, saveRequest, notifyProjectTeamNewRequest, notifyNewRequest, renderRequests, sendVisitReportEmail, tatBadge, reviewWaitBadge, toggleRequestTimeline, fmtDateTime, slaGap, renderRequestStageTimeline, renderCNCStageTimeline, setCNCStageActual, uploadCNCRoughDrawing, uploadCNCPreviewPdf, emailSalesPreviewUpdated, renderRequestCard, viewRequestReadOnly, updateRequestFields, acknowledgeRequest, confirmAcknowledge, sendAssignmentEmails, changePlannedDate, advanceRequestStatus, convertRequestToProject, confirmConvertRequestToProject, exportProjectsCSV, parseCSV, importProjectsCSV, exportRequestsCSV, askDeleteRequest } from '../sections/requests/requestsTab.js';
...
export function installDomGlobals(){
  Object.assign(window, {
    ...
    toggleCard,
    renderDetail,
    filterByOpenConstraints,
    clearOpenConstraintsFilter,
    fieldRowHTML,
    captureDPRArrivalGeoLocation,
    captureGeoLocation,
    reqFieldChanged,
    ...
    renderCNCStageTimeline,
    setCNCStageActual,
    uploadCNCRoughDrawing,
    uploadCNCPreviewPdf,
    emailSalesPreviewUpdated,
    renderRequestCard,
    viewRequestReadOnly,
    updateRequestFields,
    acknowledgeRequest,
